...
class PushNotifications {
    ...
    try {
      ...
      if (kIsWeb) {
        ...
        token = await _firebaseMessaging.getToken(
            vapidKey:
                "BPA9r_00LYvGIV9GPqkpCwfIl3Es4IfbGqE9CSrm6oeYJslJNmicXYHyWOZQMPlORgfhG8RNGe7hIxmbLXuJ92k"); //have to change this
  ...
  static saveTokentoFirestore({required token}) async {
    bool isUserLoggedin = await AuthMethods.isLoggedIn();
    print("User is logged in $isUserLoggedin");
    if (isUserLoggedin) {
      await FireStoreMethods().saveUserToken(token!);
  ...
  static Future localNotiInit() async {
    ...
    final DarwinInitializationSettings initializationSettingsDarwin =
      ...
      // Removed deprecated `onDidReceiveLocalNotification`
